...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      <?php
         $select_users = $conn->prepare("SELECT * FROM users WHERE user_type='cour'");
      ...
      <div class="box">
         ...
         <p> user type : <span style=" color:<?php if($fetch_users['user_type'] == 'cour'){ echo 'red'; }; ?>"><?= $fetch_users['user_type']; ?></span></p>
