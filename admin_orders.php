...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <?php
         $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'pending' OR payment_status = 'preparing order' OR payment_status = 'order picked up' OR payment_status = 'to be delivered'");
